...
- Commit: `bee788e` (bee788e08fa43230bb35361a747caa712688c78e)
- Commit date: 2026-06-21T11:57:06-03:00
- Generated (UTC): 2026-06-27 07:22:41Z
- Files counted: **556** (all git-tracked `*.py` files)
- Total lines: **78,577**
...
| Section | Files | LOC |
|:--------|------:|----:|
| controllers | 14 | 1,863 |
| repositories | 51 | 4,449 |
| widgets | 219 | 24,900 |
| services | 81 | 8,804 |
| tests | 70 | 27,549 |
| automation | 33 | 4,609 |
...
## controllers (14 files, 1,863 LOC)

| LOC | File |
|----:|:-----|
| 345 | `controllers/app_controller/cache_warmer.py` |
| 336 | `controllers/session_manager.py` |
...
| 99 | `controllers/app_controller/settings.py` |
...
## repositories (51 files, 4,449 LOC)
...
| 153 | `repositories/card_repository/builder.py` |
...
## widgets (219 files, 24,900 LOC)

| LOC | File |
|----:|:-----|
| 906 | `widgets/panels/card_table_panel/pile_view.py` |
| 537 | `widgets/panels/card_table_panel/table_view.py` |
| 452 | `widgets/frames/app_frame/handlers/app_frame.py` |
...
| 373 | `widgets/frames/app_frame/handlers/sideboard_guide_record.py` |
| 361 | `widgets/panels/card_table_panel/table_renderers.py` |
| 358 | `widgets/panels/card_panel/html_renderer.py` |
| 338 | `widgets/frames/app_frame/handlers/deck_content.py` |
| 333 | `widgets/panels/card_table_panel/grid_interaction.py` |
| 331 | `widgets/panels/card_table_panel/frame.py` |
| 331 | `widgets/panels/mana_rich_text_ctrl/handlers.py` |
| 307 | `widgets/frames/radar/handlers.py` |
| 297 | `widgets/frames/app_frame/frame/__init__.py` |
...
| 278 | `widgets/panels/card_table_panel/grid_view.py` |
| 273 | `widgets/frames/timer_alert/handlers.py` |
| 269 | `widgets/panels/card_panel/handlers.py` |
| 265 | `widgets/panels/card_inspector_panel/handlers/image_pipeline.py` |
| 264 | `widgets/panels/card_inspector_panel/frame.py` |
| 264 | `widgets/panels/deck_builder_panel/handlers.py` |
| 261 | `widgets/lists/deck_results_list/handlers.py` |
| 241 | `widgets/frames/app_frame/frame/center_panel.py` |
...
| 216 | `widgets/panels/card_table_panel/grid_images.py` |
| 215 | `widgets/panels/card_table_panel/grid_render.py` |
...
| 194 | `widgets/panels/sideboard_guide_panel/frame.py` |
...
| 180 | `widgets/frames/app_frame/handlers/card_inspector_preview.py` |
...
| 166 | `widgets/frames/app_frame/handlers/sideboard_guide_io.py` |
...
| 157 | `widgets/panels/card_inspector_panel/handlers/content.py` |
...
| 149 | `widgets/panels/card_table_panel/handlers.py` |
| 147 | `widgets/panels/deck_research_panel/results_filter.py` |
| 143 | `widgets/panels/compact_radar_panel/handlers.py` |
...
| 131 | `widgets/dialogs/tutorial_dialog/dialog.py` |
| 131 | `widgets/frames/identify_opponent/handlers/radar.py` |
| 131 | `widgets/panels/deck_notes_panel/handlers.py` |
| 125 | `widgets/frames/app_frame/frame/right_panel.py` |
| 124 | `widgets/panels/sideboard_card_selector/frame.py` |
| 122 | `widgets/frames/top_cards/frame.py` |
| 121 | `widgets/panels/card_table_panel/grid_layout.py` |
...
| 114 | `widgets/panels/card_table_panel/table_columns.py` |
| 114 | `widgets/panels/deck_builder_panel/frame/__init__.py` |
| 113 | `widgets/frames/app_frame/protocol.py` |
...
| 103 | `widgets/panels/card_table_panel/scrolling.py` |
| 102 | `widgets/frames/identify_opponent/protocol.py` |
| 100 | `widgets/panels/compact_sideboard_panel/handlers.py` |
| 99 | `widgets/panels/card_table_panel/toolbar.py` |
...
| 95 | `widgets/panels/card_table_panel/placeholders.py` |
...
| 71 | `widgets/panels/card_inspector_panel/protocol.py` |
...
| 66 | `widgets/panels/card_table_panel/marquee_overlay.py` |
...
| 53 | `widgets/panels/card_table_panel/protocol.py` |
...
| 292 | `services/image_service/printing_index.py` |
| 235 | `services/gamelog_service/parser.py` |
| 214 | `services/image_service/schemas.py` |
| 202 | `services/mtgo_bridge_service/commands.py` |
| 201 | `services/image_service/downloader.py` |
...
| 129 | `services/image_service/local_resolver.py` |
...
## tests (70 files, 27,549 LOC)

| LOC | File |
|----:|:-----|
| 1600 | `tests/test_card_images_cache.py` |
| 1263 | `tests/test_metagame_repository.py` |
| 986 | `tests/test_bundle_snapshot_client.py` |
| 958 | `tests/test_gamelog_parser.py` |
| 932 | `tests/test_search_service.py` |
| 904 | `tests/test_collection_service.py` |
| 760 | `tests/test_mtggoldfish.py` |
| 741 | `tests/test_identify_opponent_radar.py` |
| 740 | `tests/test_radar_service.py` |
| 713 | `tests/test_timer_alert_async.py` |
| 683 | `tests/test_deck_repository.py` |
| 639 | `tests/test_comp_rules_service.py` |
| 601 | `tests/ui/test_deck_selector.py` |
| 574 | `tests/test_card_repository.py` |
| 563 | `tests/test_image_service.py` |
| 515 | `tests/test_card_panel_html_renderer.py` |
| 513 | `tests/test_results_filter.py` |
| 511 | `tests/test_remote_snapshot_client.py` |
| 496 | `tests/test_card_data_refresh.py` |
| 480 | `tests/test_deck_printing.py` |
| 461 | `tests/test_deck_results_list.py` |
| 445 | `tests/test_cache_warmer.py` |
| 432 | `tests/test_match_history_metrics.py` |
| 430 | `tests/test_session_manager.py` |
| 427 | `tests/test_card_art_selection_fixture.py` |
| 425 | `tests/test_card_table_panel_sorting.py` |
| 420 | `tests/test_mtgo_bridge_client.py` |
| 394 | `tests/test_card_data_aliases.py` |
...
| 366 | `tests/test_card_image_display_logic.py` |
| 337 | `tests/ui/test_pile_view_selection.py` |
...
| 306 | `tests/test_paths.py` |
| 276 | `tests/test_math_utils.py` |
| 276 | `tests/test_radar_card_stats.py` |
| 274 | `tests/test_search_filters.py` |
| 263 | `tests/test_mana_icon_factory.py` |
| 256 | `tests/test_wx_layout.py` |
| 245 | `tests/test_deck_service.py` |
| 224 | `tests/test_archetype_resolver.py` |
| 221 | `tests/test_deck_averager.py` |
| 205 | `tests/test_atomic_io.py` |
| 203 | `tests/test_radar_bulk_replace.py` |
| 201 | `tests/test_card_panel_stats_lookup.py` |
| 186 | `tests/test_rules_browser_html_render.py` |
| 182 | `tests/test_deck_formatting.py` |
| 182 | `tests/ui/test_marquee_selection.py` |
| 176 | `tests/test_card_render.py` |
| 176 | `tests/test_reset_helpers.py` |
| 156 | `tests/test_i18n.py` |
| 147 | `tests/test_card_index_storage.py` |
| 147 | `tests/test_store_service.py` |
| 146 | `tests/test_sideboard_guide_csv.py` |
| 143 | `tests/test_logging_config.py` |
| 138 | `tests/test_mtggoldfish_visual.py` |
| 128 | `tests/test_perf.py` |
| 125 | `tests/test_helpers.py` |
| 113 | `tests/test_help_assets.py` |
| 99 | `tests/test_layout_repaint_guard.py` |
| 95 | `tests/test_runtime_flags.py` |
| 73 | `tests/test_collection_loading.py` |
| 72 | `tests/test_opponent_detection.py` |
| 30 | `tests/ui/test_marquee_overlay.py` |
| 18 | `tests/conftest.py` |

## automation (33 files, 4,609 LOC)

| LOC | File |
|----:|:-----|
| 693 | `automation/cli.py` |
| 435 | `automation/client.py` |
| 310 | `automation/server/screenshot.py` |
| 261 | `automation/server/video_capture.py` |
| 254 | `automation/capture_panel_transition.py` |
| 233 | `automation/server/introspection.py` |
...
| 125 | `automation/server/__init__.py` |
| 122 | `automation/e2e_tests/__init__.py` |
| 122 | `automation/server/video.py` |
| 118 | `automation/server/scroll_perf.py` |
...
## utils (71 files, 3,403 LOC)

| LOC | File |
|----:|:-----|
| 492 | `utils/constants/__init__.py` |
| 195 | `utils/constants/paths.py` |
| 144 | `utils/diagnostics.py` |
| 139 | `utils/math_utils.py` |
| 133 | `utils/atomic_io.py` |
| 133 | `utils/constants/timing.py` |
| 132 | `utils/deck.py` |
| 122 | `utils/image_effects.py` |
| 100 | `utils/background_worker.py` |
| 99 | `utils/constants/gameplay.py` |
| 97 | `utils/constants/ui_layout.py` |
| 85 | `utils/json_io.py` |
| 73 | `utils/logging_config.py` |
| 64 | `utils/i18n/_en_us/guide.py` |
| 64 | `utils/i18n/_pt_br/guide.py` |
| 62 | `utils/i18n/_en_us/app.py` |
| 62 | `utils/i18n/_pt_br/app.py` |
| 54 | `utils/perf.py` |
| 50 | `utils/constants/ui_images.py` |
| 45 | `utils/i18n/_en_us/__init__.py` |
| 45 | `utils/i18n/_pt_br/__init__.py` |
| 43 | `utils/i18n/__init__.py` |
| 40 | `utils/i18n/_en_us/tabs.py` |
| 40 | `utils/i18n/_pt_br/tabs.py` |
