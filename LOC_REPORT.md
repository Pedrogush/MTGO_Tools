...
- Commit: `a95175e` (a95175efbe2cf45a0bad59ea4a09372d4ea15a71)
- Commit date: 2026-06-03T14:09:05-03:00
- Generated (UTC): 2026-06-05 07:47:36Z
- Files counted: **524** (all git-tracked `*.py` files)
- Total lines: **70,458**
...
## widgets (201 files, 22,453 LOC)

| LOC | File |
|----:|:-----|
| 921 | `widgets/panels/card_table_panel/pile_view.py` |
| 704 | `widgets/panels/card_table_panel/grid_view.py` |
...
| 213 | `widgets/frames/app_frame/frame/__init__.py` |
...
| 339 | `tests/ui/test_pile_view_selection.py` |
