...
def test_deck_selector_loads_archetypes_and_mainboard_stats(shared_frame):
    frame = shared_frame
...
@pytest.mark.usefixtures("wx_app")
def test_format_change_reloads_decks_with_any_selected(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_duplicate_archetype_delivery_skips_redundant_deck_reload(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_load_decks_debounces_rapid_identical_target(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_present_deck_text_updates_ui_without_download_io(shared_frame):
    frame = shared_frame
...
@pytest.mark.usefixtures("wx_app")
def test_builder_search_populates_results(shared_frame):
    frame = shared_frame
...
@pytest.mark.usefixtures("wx_app")
def test_notes_replaced_on_deck_switch(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_file_deck_load_uses_file_deck_key_for_notes(shared_frame):
    frame = shared_frame
    frame.controller.deck_notes_store.clear()
...
@pytest.mark.usefixtures("wx_app")
def test_format_change_reloads_decks_through_real_load_decks(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_archetypes_error_resets_loading_flag(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_decks_error_resets_loading_flag_and_shows_failed_load(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_deck_download_error_disables_actions(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_load_decks_archetype_scope_without_archetype_is_guarded(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_archetype_selected_skips_while_loading(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_deck_selected_skips_while_loading(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_deck_content_ready_clears_current_deck_for_manual_source(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_copy_clicked_empty_deck_warns_without_clipboard_write(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_save_clicked_empty_deck_warns_without_save(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_load_deck_clicked_file_read_error_is_handled(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_copy_clicked_writes_deck_to_clipboard(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_load_deck_clicked_renders_selected_file(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_daily_average_clicked_skips_while_loading(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_daily_average_clicked_no_op_without_decks(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_on_daily_average_clicked_builds_and_renders(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_deck_filter_through_frame_narrows_and_empties_deck_list(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_removed_deck_is_reported_calmly_and_accurately(shared_frame):
...
@pytest.mark.usefixtures("wx_app")
def test_a_real_download_failure_still_raises_an_error_box(shared_frame):
