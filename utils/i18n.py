...
MESSAGES: Final[dict[LocaleCode, dict[str, str]]] = {
    "en-US": {
        ...
        "builder.hint.mana_cost": "e.g. {1}{G}",
    ...
    "pt-BR": {
        ...
        "builder.info": "Montador de Deck: busque cartas MTG por propriedade.",
        "builder.field.card_name": "Nome da Carta",
        "builder.field.type_line": "Linha de Tipo",
        "builder.field.mana_cost": "Custo de Mana",
        "builder.field.oracle_text": "Texto de Oracle",
        "builder.field.mana_value": "Filtro de Valor de Mana",
        "builder.filter.color_identity": "Filtro de Identidade de Cor",
        ...
        "guide.btn.flex_slots": "Flex Slots",
        "guide.btn.pin": "Fixar para Rastreador",
