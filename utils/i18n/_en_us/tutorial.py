"""Tutorial dialog UI strings. (English (United States))"""
...
MESSAGES: dict[str, str] = {
    ...
    "tutorial.step3.body": "The Tools menu opens six companion windows, each in its own window alongside the main one:\n\n•  Opponent Tracker — detects the opponent from your MTGO window title and looks up their most-played archetypes.\n•  Timer Alert — configurable countdown to warn you before time runs out in a round.\n•  Match History — parses your MTGO GameLog files and shows recent results.\n•  Metagame Analysis — a top-level breakdown of the current format.\n•  Top Cards — the most-played cards in a format, from the local card pool.\n•  Radar — card frequencies across an archetype's decklists.",
    "tutorial.step4.title": "Deck Builder",
    "tutorial.step4.body": "Switch the left panel to Builder mode to search for cards and craft your own deck.\n\n•  Type a card name or keyword in the search box.\n•  Click a result to preview it in the Card Inspector.\n•  Use “+ Mainboard” or “+ Sideboard” to add it to your deck.\n•  Open the Mana Keyboard for quick mana-cost symbol input.\n•  Use “Copy” to copy the deck list to your clipboard.",
    "tutorial.step5.title": "Sideboard Guide",
    "tutorial.step5.body": "The Sideboard Guide tab lets you record matchup-by-matchup notes.\n\n•  Add an entry for each archetype you face.\n•  Record cards to bring IN and take OUT for each matchup.\n•  Mark flex slots — cards whose count varies by matchup.\n•  Pin the guide to keep it visible while reviewing other tabs.\n•  Export or import as CSV to share guides with teammates.",
    "tutorial.step6.title": "You’re All Set!",
    "tutorial.step6.body": "That’s the quick tour of MTGO Tools.\n\nA few more tips:\n•  The File menu loads your MTGO collection, enables offline images and updates the card database; File → Preferences holds the language, deck source and average settings.\n•  Deck Notes let you keep free-form notes attached to any deck.\n•  Session state (current deck, format, window size) is saved automatically.\n\nGood luck in your matches!",
}
