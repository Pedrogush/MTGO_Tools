...
MESSAGES: dict[str, str] = {
    ...
    "builder.empty.no_results": "Nenhuma carta corresponde a estes filtros.",
    "builder.empty.no_results.hint": "Tente um nome mais curto, menos símbolos de mana, ou amplie os filtros de formato e cor.",
    "builder.status.showing": "Exibindo {count} {cards}.",
    "builder.status.card": "carta",
    ...
    "builder.check.exact_symbols": "Combinar símbolos exatos",
