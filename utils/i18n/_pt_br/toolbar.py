...
MESSAGES: dict[str, str] = {
    ...
    "toolbar.tooltip.top_cards": "Veja as cartas mais jogadas em cada formato no cache local",
    "toolbar.tooltip.radar": "Abrir o radar do arquétipo para analisar frequências de cartas",
}
