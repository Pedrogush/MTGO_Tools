...
from utils.constants.ui_layout import (
    ...
    CARD_PANEL_MIN_HEIGHT,
    CARD_VIEW_EDGE_FADE_PX,
    CARD_VIEW_SCROLL_RATE,
    CARD_VIEW_WHEEL_LINE_PX,
    CARD_VIEW_WHEEL_LINES_PER_NOTCH,
    COLLAPSE_TOGGLE_WIDTH,
    DECK_COUNT_LABEL_MIN_WIDTH,
    DECK_HISTORY_RAIL_WIDTH,
    ...
    MENU_CARET,
    MODE_SWITCH_HEIGHT,
    MODE_SWITCH_PADDING_X,
    RESEARCH_VALUE_FIELD_MIN_WIDTH,
...
# Remote snapshot feature flag and configuration
