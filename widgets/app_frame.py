...
class AppFrame(AppEventHandlers, SideboardGuideHandlers, CardTablePanelHandler, wx.Frame):
    ...
    def _build_left_panel(self, parent: wx.Window) -> wx.Panel:
        ...
        self.builder_panel = DeckBuilderPanel(
            ...
            labels={
                key.replace("builder.", ""): self._t(key)
                for key in [
                    "builder.button.deck_research",
                    "builder.info.description",
                    "builder.field.card_name",
                    "builder.field.type_line",
                    "builder.field.mana_cost",
                    "builder.field.oracle_text",
                    "builder.hint.card_name",
                    "builder.hint.type_line",
                    "builder.hint.mana_cost",
                    "builder.hint.oracle_text",
                    "builder.label.match",
                    "builder.checkbox.exact_symbols",
                    "builder.button.all",
                    "builder.label.mana_value_filter",
                    "builder.hint.mana_value",
                    "builder.label.formats",
                    "builder.label.color_identity_filter",
                    "builder.filter.any",
                    "builder.filter.at_least",
                    "builder.filter.exactly",
                    "builder.filter.not_these",
                    "builder.color.white",
                    "builder.color.blue",
                    "builder.color.black",
                    "builder.color.red",
                    "builder.color.green",
                    "builder.color.colorless",
                    "builder.button.clear_filters",
                    "builder.checkbox.use_radar_filter",
                    "builder.radar_zone.both",
                    "builder.radar_zone.mainboard",
                    "builder.radar_zone.sideboard",
                    "builder.button.open_radar",
                    "builder.column.name",
                    "builder.column.mana_cost",
                    "builder.status.results_update",
                    "builder.status.filters_cleared",
                    "builder.status.showing_cards",
                    "builder.dialog.no_radar_loaded",
                    "builder.dialog.no_radar_title",
                    "builder.status.radar_active",
                ]
            },
        )
    ...
    def _open_radar_dialog(self):
        ...
        dialog = RadarDialog(
            ...
            labels={
                "no_radar_loaded": self._t("radar.no_radar_loaded"),
                "button.export": self._t("radar.button.export"),
                "button.use_for_search": self._t("radar.button.use_for_search"),
                "box.mainboard": self._t("radar.box.mainboard"),
                "box.sideboard": self._t("radar.box.sideboard"),
                "column.card": self._t("radar.column.card"),
                "column.inclusion": self._t("radar.column.inclusion"),
                "column.expected_copies": self._t("radar.column.expected_copies"),
                "column.avg_copies": self._t("radar.column.avg_copies"),
                "column.max": self._t("radar.column.max"),
                "tooltip.copy": self._t("radar.tooltip.copy"),
                "tooltip.copies": self._t("radar.tooltip.copies"),
                "dialog.select_archetype": self._t("radar.dialog.select_archetype"),
                "dialog.generate": self._t("radar.dialog.generate"),
                "dialog.cancel": self._t("radar.dialog.cancel"),
                "dialog.close": self._t("radar.dialog.close"),
                "progress.starting": self._t("radar.progress.starting"),
                "progress.analyzing": self._t("radar.progress.analyzing"),
                "progress.success": self._t("radar.progress.success"),
                "progress.cancelled": self._t("radar.progress.cancelled"),
                "progress.failed": self._t("radar.progress.failed"),
                "export.prompt": self._t("radar.export.prompt"),
                "export.title": self._t("radar.export.title"),
                "close.warning": self._t("radar.close.warning"),
                "close.title": self._t("radar.close.title"),
            },
        )
