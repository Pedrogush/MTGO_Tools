...
class AppFrameProto(Protocol):
    ...
    left_panel_window: wx.Panel | None
    inspector_panel: wx.Panel | None
    left_toggle_btn: wx.Button | None
    inspector_toggle_btn: wx.Button | None
    _left_collapsed: bool
    _inspector_collapsed: bool
    research_panel: Any
    builder_panel: Any
    ...
    def refresh_deck_history(self) -> None: ...
    def refresh_deck_name_displays(self) -> None: ...
    def on_deck_name_clicked(self) -> None: ...
    def current_deck_name(self) -> str: ...
    def deck_name_display_text(self) -> str: ...
    def _apply_min_size(self) -> None: ...
    def _build_collapse_toggle(
        self, parent: wx.Window, *, on_click: object, tooltip: str
    ) -> wx.Button: ...
    def toggle_left_panel(self) -> None: ...
    def toggle_inspector(self) -> None: ...
    def _set_left_collapsed(self, collapsed: bool, *, persist: bool = ...) -> None: ...
    def _set_inspector_collapsed(self, collapsed: bool, *, persist: bool = ...) -> None: ...
