...
Two reports are committed under the repo root and `docs/diagrams/` and regenerated by hand after significant structural changes (renames, new packages, large file growth):
...
Both scripts support `--check` for CI drift detection.
